...
<html lang="fr"> 
    ...
    <body>
        ...
        <section class="trending products" id="trending">
            ...
            <div class="products">
                <div class="row">
                    <img src="img2/These are Chanel's 10 best-selling beauty products.jpg">
                ...
                <div class="row">
                    <img src="img2/Tonico viso_ è davvero importante e quale scegliere_.jpg" alt="">
                ...
                <div class="row">
                    <img src="img2/Skin Proud – Velvet Cloud Foaming Cleanser – Ansiktsrengöring _ ASOS.jpg" alt="">
                ...
                <div class="row">
                    <img src="img2/Rare Beauty Soft Pinch Tinted Lip Oils - The Beauty Look Book.jpg" alt="">
                ...
                <div class="row">
                    <img src="img2/On Beauty_ French Hair Care - Our Paris Editor's Guide.jpg" alt="">
                    <div class="products-text">
                        <h5>Sale</h5>
                    </div>
                    <div class="heart-icon">
                ...
                <div class="row">
                    <img src="img2/lip sleeping mask for super smooth lips.jpg" alt="">
                ...
                <div class="row">
                    <img src="img2/Idée Cadeau _ les superbes coffrets Fresh Beauty !.jpg" alt="">
                ...
                <div class="row">
                    <img src="img2/It Looks Like the Ordinary Is Leaving Sephora After Less Than 1 Year.jpg" alt="">
                    ...
                    <div class="price">
                        <h4>Acid Hylauronic</h4>
                        <p>200,00 MAD</p>
                    </div>
                </div>
                <div class="row">
                    <img src="img2/Body Scrubs.jpg" alt="">
                    <div class="products-text">
                        <h5>Sale</h5>
                    </div>
                    <div class="heart-icon">
                ...
                <div class="row">
                    <img src="img2/7 Best Highlighter Palettes_ Best Highlighters for Glowing Skin.jpg" alt="">
                ...
                <div class="row">
                    ...
                    <div class="price">
                        <h4>hair straightener Pack</h4>
                        <p>1000,00 MAD</p>
                    </div>
                </div>
                <div class="row">
                    <img src="img2/These Are the Viral Beauty Products That Took Over TikTok in 2022.jpg">
                    <div class="heart-icon">
                        <i class="fa-regular fa-heart" style="color: #000000;"></i> 
                    </div>
                    <div class="ratting">
