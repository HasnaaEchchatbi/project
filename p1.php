              ...
              <div class="cart-box"> 
                 <div class="cart-icon" >
                   ...
                   <div class="whole-cart-window hide">
                        ...
                        <div class="subtotal" name="total">Subtotal: $0.00</div>
    ...
    <section class="shop-section">
      ...
      <div class="card-wrapper">
        ...
        <img src="img2/n1.jpg" alt="" >
          <div class="details">
             <h3 name="intitule">Gold Bracelet</h3>
             <p>
              <span></span >
              <span class="price" name="price">Price: $23.44</span><br>
                  <select name="size" >
                     ...
                     <!-- <span class="add-to-cart-btn" name="connexion">Add To Cart</span> -->
             </p>
          </div>
        </div>
       </div>
