...
<!--     
    ...
    <section class="trending products" id="trending">
        ...
        <div class="products">
            <div class="row" onclick="window.location.href='p1.php'">
                <img src="img2/n1.jpg" alt="" >
            ...
            <div class="row"  onclick="window.location.href='p2.php'">
                <img src="img2/n2.jpg" alt="" >
            ...
            <div class="row" onclick="window.location.href='p3.php'">
                <img src="img2/n3.jpg" alt="" >
                ...
                <div class="price">
                    <h4>Sky Blue High Heels </h4>
                    <p>$30.44</p>
                </div>
            </div>
            <div class="row" onclick="window.location.href='p4.php'">
                <img src="img2/n4.jpg" alt="">
                ...
                <div class="price">
                    <h4>Beige Man T-shirt</h4>
                    <p>$20.50</p>
                </div>
            </div>
            <div class="row">
                <img src="img2/n5.jpg" alt="">
                <div class="products-text">
                    <h5>Sale</h5>
                </div>
                <div class="heart-icon">
                ...
                <div class="price">
                    <h4>Black Satin Dress</h4>
                    <p>$70.00</p>
                </div>
            </div>
            <div class="row">
                <img src="img2/n6.jpg" alt="">
                ...
                <div class="price">
                    <h4>Black Man Jacket</h4>
                    <p>$23.44</p>
                </div>
            </div>
            <div class="row">
                <img src="img2/n7.jpg" alt="">
